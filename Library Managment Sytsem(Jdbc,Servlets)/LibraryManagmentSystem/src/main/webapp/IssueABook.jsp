    ...
    <nav>
      ...
      <div class="dcard">
        <div  style="display: flex; flex-direction: column; margin-right: 100px;">
            <form action="req-book" method="post">
            	<div class="row">
                ...
                <div class="row">
                  ...
                  <button class="btn waves-effect waves-light button1" type="submit" name="action" style="width: 100%;">Request Book
        ...
        <div class="t1 table1">
        	...
        	%>
        	<script>
        	alert("Reqest Sent Seccessfully");
        	</script>
        	<%}else if(msg=="no"){ %>
        	<script>
        	alert("No Book Found");
